...
ENV PLATFORM_OPTS=
ENV RUNTIME_OPTS "-DruntimeDirectory=/runtime-data -Dorg.researchspace.config.baselocation=/runtime-data/config -DappsDirectory=/apps -Dconfig.environment.shiroConfig=/runtime-data/config/shiro.ini -Dlog4j.configurationFile=classpath:org/researchspace/logging/log4j2-trace.xml -Dorg.eclipse.jetty.server.Request.maxFormContentSize=104857600"
