...
public class HandlebarsHelperRegistry {
    ...
    public HandlebarsHelperRegistry(RepositoryManager repositoryManager, FieldDefinitionManager fieldDefinitionManager,
            FieldsBasedSearch fieldsBasedSearch, QueryTemplateCache queryTemplateCache, LabelCache labelCache, Configuration config, PlatformStorage platformStorage, CacheManager cacheManager) {
        this.helpers = ImmutableList.of(new AskHelperSource(), new HasPermissionHelperSource(),
                ...
                new DateTimeHelperSource(), new I18nHelperSource(config, platformStorage, cacheManager));
    }
